...
class SliderWidget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => '<button class="depicter-edit-slider elementor-button elementor-button-success" style="padding: 5px 10px; width:100%;">' . esc_html__( 'Edit Slider', 'depicter' ) . '</button>',
			]
		);
	...
	protected function render() {
		...
		if ( $settings['slider_id'] ) {
			echo \Depicter::front()->render()->document( $settings['slider_id'], ['useCache' => true] );
		}
